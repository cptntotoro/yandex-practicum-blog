package ru.practicum.dao.comment;
...
public class CommentDao {
    ...
    private CommentDao(UUID uuid, UUID postUuid, String content, LocalDateTime dateTime) {
        this.uuid = uuid;
    ...
    public static class Builder {
        ...
        public CommentDao build() {
            return new CommentDao(uuid, postUuid, content, dateTime);
        }
